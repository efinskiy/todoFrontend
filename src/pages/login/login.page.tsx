...
export const LoginPage = () => {
    ...
    const formOnSubmit = () => {
        if (!loginFormError.username && !loginFormError.password) {
            sendLogin(loginForm).then(d => {
                authUser(d.data);
        ...
        <div className={css.login_container}>
            ...
            <div className={css.credentials}>
                <div className={css.field}>
                    ...
                    {
                        loginFormError.username && <span>
                            Логин должен быть более 3х символов.
                        </span>
                    }
                </div>
                <div className={css.field}>
                    ...
                    {
                        loginFormError.password && <span>
                            Пароль должен быть более 5х символов.
                        </span>
                    }
                </div>
